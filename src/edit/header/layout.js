...
export default function LayoutHeader( { categories, isLoading } ) {

  return (
    <>
        {/* <div className='df_fb-filter-search'>
            <form method="post">
                <div classname="form-row">
                    <input type="text" placeholder="Search layouts (e.g. Agency, eCommerce)" name="filter_search_val" />
                    <button type="submit" name="search_submit"><img src={ search } /></button>
                </div>
            </form>
        </div> */}
        {/* dropdown filter */}
